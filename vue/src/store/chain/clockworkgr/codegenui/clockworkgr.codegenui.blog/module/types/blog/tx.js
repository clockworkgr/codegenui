...
const baseMsgCreatePost = { creator: '', title: '', body: '', votes: 0 };
export const MsgCreatePost = {
    encode(message, writer = Writer.create()) {
        ...
        if (message.votes !== 0) {
            writer.uint32(32).int32(message.votes);
        }
        return writer;
    },
    decode(input, length) {
...
const baseMsgCreatePostResponse = { id: '' };
...
const baseMsgDeletePost = { creator: '', id: '' };
...
export class MsgClientImpl {
    ...
    CreatePost(request) {
        ...
        const promise = this.rpc.request('clockworkgr.codegenui.blog.Msg', 'CreatePost', data);
        return promise.then((data) => MsgCreatePostResponse.decode(new Reader(data)));
    }
    UpdatePost(request) {
        const data = MsgUpdatePost.encode(request).finish();
        const promise = this.rpc.request('clockworkgr.codegenui.blog.Msg', 'UpdatePost', data);
        return promise.then((data) => MsgUpdatePostResponse.decode(new Reader(data)));
    }
    DeletePost(request) {
        const data = MsgDeletePost.encode(request).finish();
        const promise = this.rpc.request('clockworkgr.codegenui.blog.Msg', 'DeletePost', data);
