...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name QueryPostAll
   * @request GET:/clockworkgr/codegenui/blog/post
   */
  queryPostAll = (
    query?: {
    ...
    this.request<BlogQueryAllPostResponse, RpcStatus>({
      path: `/clockworkgr/codegenui/blog/post`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
